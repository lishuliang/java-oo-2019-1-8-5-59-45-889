...
public class Teacher extends Person {
    ...
    public void setTeacher(LinkedList<Klass> linkedList){
        for (int i = 0; i < linkedList.size(); i++){
            linkedList.get(i).setTeacher(this);
        }
    }

    public void printJoin(Klass klass){
        System.out.print("I am " + this.getName() + ". I know Jerry has joined " + klass.getDisplayName() + ".\n");
    }

    public void printLeader(Klass klass){
        System.out.print("I am " + this.getName() + ". I know Jerry become Leader of " + klass.getDisplayName() + ".\n");
    }
}
